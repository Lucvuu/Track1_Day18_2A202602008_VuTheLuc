...
**Nguồn:** Phản hồi từ phiên phỏng vấn trực tiếp do Đỗ Thị Thanh Loan facilitate — người ngoài nhóm tự dùng bản prototype chạy local trên máy tính của Loan trong khi Loan xem trực tiếp thao tác và hỏi. Chi tiết từng phản hồi ở `prototype-feedback-note.md`.
...
- Trong nhóm người được test có 1 Lab Coach (Lê Thiên Khang) — [CẦN XÁC NHẬN: phản hồi số mấy trong prototype-feedback-note.md] — nhưng chưa rõ đây có phải lúc đang trong ca dạy bận rộn hay không, và những người còn lại vẫn không rõ có ai từng làm vai trò tương tự không.
