...
| **Expectation** — coach biết AI sắp làm gì trước khi AI chạy | Banner đầu trang nói rõ AI chưa phân tích/tổng hợp evidence gì cho tới khi coach bấm yêu cầu; nút "Kiểm tra nhóm đang chậm" chỉ bật sau khi chọn checkpoint. Checkpoint list vẫn hiển thị sẵn số liệu tổng hợp kiểu-VLAB (ví dụ "7/10 nhóm đã qua") — đây là dữ liệu có sẵn từ trước, không phải AI mới phân tích. | Banner nêu rõ: "AI đã tự động gom tín hiệu và tạo review queue... AI không liên hệ learner cho tới khi bạn approve." Coach biết ngay khi mở tab rằng queue là do AI tự tạo, không phải coach yêu cầu. | (Thiết kế, chưa test) AI hiển thị trước hành động dự kiến và mức chắc chắn trước khi gửi check-in, theo policy coach đã đặt. |
